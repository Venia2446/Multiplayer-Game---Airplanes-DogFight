...
public class RestartLevelOnDeath : MonoBehaviour
{
    ...
    void Update()
    {
        ScoreText.SetText($"Player1: {playerScore1}  |  Player2: {playerScore2}");
        ...
        if (Airplane1 != null & Airplane2 != null)
        {
            ...
            {
                if (airplane1_Control.Player1Status() == true) playerScore2 += 1;
                ...
                if (airplane2_Control.Player2Status() == true) playerScore1 += 1;
